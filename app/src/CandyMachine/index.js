  ...
  const getCandyMachineState = async () => {
   ...
   if (data.length !== 0) {
    for (const mint of data) {
      ...
      console.log("walletAddress.publicKey", walletAddress.publicKey.toString())
      //console.log("response.json()", mint.data.CandyMachine)
...
const renderDropTimer = () => {
  ...
  if (currentDate.getUTCDate() < dropDate.getUTCDate()) {
